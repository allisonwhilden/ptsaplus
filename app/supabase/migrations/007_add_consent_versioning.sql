-- Consent Version Tracking System
...
-- Add versioning columns to existing consent_records table
ALTER TABLE consent_records 
  ADD COLUMN IF NOT EXISTS policy_version_id UUID REFERENCES policy_versions(id),
  ADD COLUMN IF NOT EXISTS superseded_by UUID REFERENCES consent_records(id),
...
-- Insert consent requirements for features
